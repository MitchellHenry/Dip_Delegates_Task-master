...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + "/Users/Mitchell/Desktop/Dip_Delegates_Task-master/Dip_Delegates_Task-master/Data/data.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + "/Users/Mitchell/Desktop/Dip_Delegates_Task-master/Dip_Delegates_Task-master/Data/data.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + "/Users/Mitchell/Desktop/Dip_Delegates_Task-master/Dip_Delegates_Task-master/Data/_WriteFile.txt";  // change to appropriate path
