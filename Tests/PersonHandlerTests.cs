...
namespace PersonHandlerTests
{
    public class PersonHandlerTests
    {
        ...
        private string csvPath = Environment.GetEnvironmentVariable("HOME") + "/Users/Mitchell/Desktop/Dip_Delegates_Task-master/Dip_Delegates_Task-master/Data/processed_data.csv"; // change to appropriate path
